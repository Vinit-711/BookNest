...
export default function BookCards({ book }) {
  return (
    <div className="group h-full relative min-w-40 md:w-40 md:h-full gap-1 md:min-w-[20rem] bg-white rounded-xl shadow-md overflow-hidden text-wrap animate-scrollX">
      <img
        src={book.image}
        alt={book.title}
